...
export default class FirstInningScreen extends Component {
  ...
  handleWicket = (batter) => {
    this.setState((prevState) => {
      let newState = { wickets: prevState.wickets + 1, wickets2: prevState.wickets2 + 1 };
      if (batter === 'batter1') {
        newState.batter1 = '';
    ...
    return (
      <>
        <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.gotoscreenbutton} onPress={() => this.navigateToSecondScreen()}>

          <Text style={styles.gotoscreentext}> Go to Second Innings Screen (Click Me) </Text>
